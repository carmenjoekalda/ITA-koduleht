        ...
        <div className="header">
            <div className="top">
                <div className="top-social">
                    ...
                    <path d="M19.15 1H14.2C12.012 1 9.91354 1.86919 8.36637 3.41637C6.81919 4.96354 5.95 7.06196 5.95 9.25V14.2H1V20.8H5.95V34H12.55V20.8H17.5L19.15 14.2H12.55V9.25C12.55 8.81239 12.7238 8.39271 13.0333 8.08327C13.3427 7.77384 13.7624 7.6 14.2 7.6H19.15V1Z" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    ...
                    <path d="M17.5 24.8333C21.55 24.8333 24.8333 21.55 24.8333 17.5C24.8333 13.4499 21.55 10.1667 17.5 10.1667C13.4499 10.1667 10.1667 13.4499 10.1667 17.5C10.1667 21.55 13.4499 24.8333 17.5 24.8333Z" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M1 24.8333V10.1667C1 5.10406 5.10406 1 10.1667 1H24.8333C29.8959 1 34 5.10406 34 10.1667V24.8333C34 29.8959 29.8959 34 24.8333 34H10.1667C5.10406 34 1 29.8959 1 24.8333Z" stroke="black" stroke-width="2"/>
                    <path d="M27.5833 7.43592L27.6025 7.41463" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </div>
                <div className="search" >
                    ...
                    <div class="search-container">
                            ...
                            <svg class="search-icon" viewBox="0 0 24 24" fill="none" stroke="#757575" stroke-width="2">
