                ...
                <div className="tunnustuste-page">
                    <div className="d-flex flex-row justify-content-between mb-5">
                        ...
                        <div className="position-relative">
                            <input type="text" className="search ps-2" style={{ transform: 'translate(32px)' }}></input>
                            <SearchIcon height="2rem" width="2rem" style={{ transform: 'translate(-12px, -2px)' }} />
                        </div>
                    </div>
                    ...
                    <div className="d-flex justify-content-center align-items-center buttons">
                        ...
                        <button className={activeButton === 1 ? "active-button" : ""} onClick={() => setActiveButton(1)}>1</button>
                        <button className={activeButton === 2 ? "active-button" : ""} onClick={() => setActiveButton(2)}>2</button>
                        <button>...</button>
